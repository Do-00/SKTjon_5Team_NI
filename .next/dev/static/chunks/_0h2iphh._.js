...
;
;
const mockingEnabledPromise = ("TURBOPACK compile-time truthy", 1) ? Promise.resolve().then(()=>{
    const e = new Error("Cannot find module '@/mocks/browser'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
}).then(async ({ default: worker })=>{
    if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
    ;
    await worker.start({
...
//# sourceMappingURL=_0h2iphh._.js.map